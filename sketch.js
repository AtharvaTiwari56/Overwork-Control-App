...
function draw() {
  if(gameState === "HomeScreen") {
    ...
    morecontent7.position(displayWidth/2 - 295, displayHeight/2 - 20);
    morecontent6.position(displayWidth/2 - 295, displayHeight/2 - 50);
    morecontent5.position(displayWidth/2 - 295, displayHeight/2 - 80);
    morecontent4.position(displayWidth/2 - 295, displayHeight/2 - 110);
    morecontent3.position(displayWidth/2 - 295, displayHeight/2 - 140);
    morecontent2.position(displayWidth/2 - 295, displayHeight/2 - 170);
    morecontent1.position(displayWidth/2 - 295, displayHeight/2 - 200);
    morecontent.position(displayWidth/2 - 295, displayHeight/2 - 230);
    
    title1.position(displayWidth/2 - 170, displayHeight/2 - 300);
    button1.position(displayWidth/2 -65, displayHeight/2 + 90);
    button2.position(displayWidth/2 - 70, displayHeight/2 + 40);
    ...
    button2.mousePressed(() => {
      gameState = "TipScreen";
      button3.position(displayWidth/2 -295, displayHeight/2 - 320);
      button2.hide();
      title1.hide();
      button1.hide();
      morecontent.hide();
    ...
    title.position(displayWidth/2 - 270, displayHeight/2 - 150);
   
    input.position(displayWidth/2- 100, displayHeight/2 - 80);
    button.position(displayWidth/2 - 100, displayHeight/2 - 40);
    button.mousePressed(() => {
    ...
    content.position(displayWidth/2 - 255, displayHeight/2 - 150);
    content1.html("alarm will ring after the specified time is over. ");
    content1.position(displayWidth/2 - 255, displayHeight/2 - 90);
